	    ...
	    <div class="container">
	        <div class="row">
	            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8 offset-xl-2">
	                ...
	                <h1 class="pagetitle__heading">Psychiatric Consultation</h1>
	                <p class="pagetitle__desc mb-30">We have a experienced psychiatrist for your in-depth consultations. Our
	                    professional provide a confidential and supportive care to discuss your concerns and wide variety of
	                    mental health conditions such as anxiety, depression or other mental health conditions. These help
	                    for complete diagnosis and develop a personalized treatment plan.
	                </p>
	        ...
	        <div class="row">
	            <div class="col-sm-12 col-md-12 col-lg-8">
	                <div class="text-block mb-50">
	                    <p class="text-block__desc mb-20 font-weight-bold color-secondary">We have a experienced
	                        psychiatrist for your in-depth consultations. Our professional provide a confidential and
	                        supportive care to discuss your concerns and wide variety of mental health conditions such as
	                        anxiety, depression or other mental health conditions. These help for complete diagnosis and
	                        develop a personalized treatment plan.</p>
	                    ...
	                    <p class="text-block__desc mb-20">We have a experienced psychiatrist for your in-depth
	                        consultations. Our professional provide a confidential and supportive care to discuss your
	                        concerns and wide variety of mental health conditions such as anxiety, depression or other
	                        mental health conditions. These help for complete diagnosis and develop a personalized treatment
	                        plan.</p>
	                    <p class="text-block__desc mb-20">We have a experienced psychiatrist for your in-depth
	                        consultations. Our professional provide a confidential and supportive care to discuss your
	                        concerns and wide variety of mental health conditions such as anxiety, depression or other
	                ...
	                <ul class="list-items list-unstyled mb-60 pl-40">
	                    <li>Nullam ut lectus malesuada, accumsan risus eu, auctor enim.</li>
	                    <li>Nullam vel sem tempus, volutpat est a, tristique metus.</li>
	                    <li>Vestibulum non quam ac augue ullamcorper pharetra.</li>
	                </ul>
	                <div class="widget-plan mb-60">
	                    <div class="widget__body">
	                        <h5 class="widget__title"> Care Plans</h5>
	                ...
	                <div class="text-block mb-50">
	                    <h5 class="text-block__title">Core Values</h5>
	                    ...
	                    <div class="slick-carousel"
	                        ...
	                        <div class="member">
	                            ...
	                            <div class="member__info">
	                                <h5 class="member__name"><a href="doctors-single-doctor1.html">Dr. Kenison Shretha</a>
	                                </h5>
	                                <p class="member__job">Specialist</p>
	                            </div><!-- /.member-info -->
	                        </div><!-- /.member -->
	                ...
	                <aside class="sidebar has-marign-left sticky-top">
	                    <div class="widget widget-services">
	                        ...
	                        <div class="widget-content">
	                            <ul class="list-unstyled mb-0">
	                                <li><a href="#"><span>Therapeutic Intervention</span><i
	                                            class="icon-arrow-right"></i></a></li>
	                                <li><a href="#"><span>Medication Management</span><i class="icon-arrow-right"></i></a>
	                                </li>
	                                <li><a href="#"><span>Telepsychiatry Services</span><i class="icon-arrow-right"></i></a>
	                                </li>
	                    ...
	                    <div class="widget widget-help bg-overlay bg-overlay-secondary-gradient">
	                        ...
	                        <div class="widget-content">
	                            ...
	                            <a href="tel:+2+9779851096229" class="phone__number">
	                                <i class="icon-phone"></i> <span>+9779851096229</span>
	                            </a>
	                        </div><!-- /.widget-content -->
	                    </div><!-- /.widget-help -->
	                    <div class="widget widget-schedule">
	                        <div class="widget-content">
	                            ...
	                            <ul class="time__list list-unstyled mb-0">
	                                <li><span>Sunday - Friday</span><span>8.00 - 7:00 pm</span></li>
