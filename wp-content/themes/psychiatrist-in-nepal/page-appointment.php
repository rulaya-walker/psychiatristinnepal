                ...
                <div class="slick-carousel"
                    ...
                    <div class="member">
                        ...
                        <div class="member__info">
                            ...
                            <p class="member__desc">Muldoone obtained his undergraduate degree in Biomedical Engineering
                                at Tulane
                    ...
                    <div class="member">
                        ...
                        <div class="member__info">
                            ...
                            <p class="member__job">Cardiology Specialist</p>
                            <p class="member__desc">Brian specializes in treating skin, hair, nail, and mucous membrane.
                                He also
                    ...
                    <div class="member">
                        ...
                        <div class="member__info">
                            ...
                            <p class="member__desc">Black diagnose and treat diseases of the urinary tract in both men
                                and women.
                                He
                    ...
                    <div class="member">
                        ...
                        <div class="member__info">
                            ...
                            <p class="member__desc">Skar play a very important role in your health care. People working
                                in the
                                clinical laboratory are responsible for conducting tests that provide crucial
                                information.</p>
                            <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                                <a href="doctors-single-doctor1.html" class="btn btn__secondary btn__link btn__rounded">
                                    <span>Read More</span>
                    ...
                    <div class="member">
                        ...
                        <div class="member__info">
                            ...
                            <p class="member__desc">Barker help care for patients every day by providing their doctors
                                with the
                    ...
                    <div
                        ...
                        <div>
                            <ul class="contact__list list-unstyled mb-30">
                                <li>
                                    <i class="icon-phone"></i><a href="tel:+5565454117">Emergency Line: (+977)
                                        +9779851096229</a>
                                </li>
                                <li>
                                    <i class="icon-location"></i><a href="#">Location: Lagankhel, Lalitpur</a>
                                </li>
                                <li>
                                    <i class="icon-clock"></i><a href="contact-us.html">Sun- Fri: 8:00 am - 7:00 pm</a>
                                </li>
                            </ul>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-1">
                ...
                <p class="heading__desc mb-30">We are committed to being the region’s premier healthcare network by
                    providing
                    patient-centered care that inspires clinical and service excellence, making us the first and best
                    choice
                    for our patients, employees, physicians, employers, volunteers and communities. We serve the
                    community by
